      ...
      <nav class="site-nav dark js-site-navbar mb-5 site-navbar-target">
        <div class="container">
          <div class="site-navigation">
            <a href="#home-section" class="logo m-0 float-left nav-link">Launch <span class="text-primary">.</span>
            </a>
              ...
              <li class="has-children">
                ...
                <ul class="dropdown">
                  ...
                  <li class="has-children">
                    ...
                    <ul class="dropdown">
                      <li>
                        <a href="#" class="nav-link">Sub Menu One</a>
                      </li>
                      <li>
                        <a href="#" class="nav-link">Sub Menu Two</a>
                      </li>
                      <li>
                        <a href="#" class="nav-link">Sub Menu Three</a>
                      </li>
                    </ul>
                  </li>
                  <li>
